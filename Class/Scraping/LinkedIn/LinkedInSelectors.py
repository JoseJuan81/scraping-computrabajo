class LinkedInSelectors:
    ...
    CANDIDATE_EMAIL = "ul[aria-live='prolite'] li:nth-child(2) a > div span:nth-child(2)"
    ...
    CANDIDATE_PHONE = "ul[aria-live='prolite'] li:nth-child(3) div > div span:nth-child(2)"
    ...
    PAGINATION_BUTTONS_SELECTOR = "ul.artdeco-pagination__pages.artdeco-pagination__pages--number li"
    PAGINATION_CURRENT_SELECTOR = "ul.artdeco-pagination__pages.artdeco-pagination__pages--number li.selected"